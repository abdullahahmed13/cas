...
.field static final a:Ljava/lang/String; = "dexopt/baseline.prof"

.field private static final b:Ljava/lang/String; = "ProfileInstaller"

.field private static final c:Ljava/lang/String; = "/data/misc/profiles/cur/0"

.field private static final d:Ljava/lang/String; = "primary.prof"
...
.method static d(Landroid/content/Context;Ljava/util/concurrent/Executor;Landroidx/profileinstaller/i$d;)V
    ...
    .line 11
    invoke-static {p1, p2, p0, v0}, Landroidx/profileinstaller/i;->h(Ljava/util/concurrent/Executor;Landroidx/profileinstaller/i$d;ILjava/lang/Object;)V
...
.method static h(Ljava/util/concurrent/Executor;Landroidx/profileinstaller/i$d;ILjava/lang/Object;)V
    .locals 1
    .param p0    # Ljava/util/concurrent/Executor;
        .annotation build Landroidx/annotation/o0;
        .end annotation
...
.method private static i(Landroid/content/res/AssetManager;Ljava/lang/String;Landroid/content/pm/PackageInfo;Ljava/io/File;Ljava/lang/String;Ljava/util/concurrent/Executor;Landroidx/profileinstaller/i$d;)Z
    .locals 8
    ...
    .line 36
    :cond_0
    invoke-virtual {v0}, Landroidx/profileinstaller/c;->h()Landroidx/profileinstaller/c;
    ...
    .line 40
    invoke-virtual {p0}, Landroidx/profileinstaller/c;->l()Landroidx/profileinstaller/c;
    ...
    .line 44
    invoke-virtual {p0}, Landroidx/profileinstaller/c;->m()Z
...
.method public static j(Landroid/content/Context;)V
    ...
    .line 7
    .line 8
    invoke-static {p0, v0, v1}, Landroidx/profileinstaller/i;->k(Landroid/content/Context;Ljava/util/concurrent/Executor;Landroidx/profileinstaller/i$d;)V
...
.method public static k(Landroid/content/Context;Ljava/util/concurrent/Executor;Landroidx/profileinstaller/i$d;)V
    .locals 1
    .param p0    # Landroid/content/Context;
        .annotation build Landroidx/annotation/o0;
        .end annotation
    ...
    .line 2
    invoke-static {p0, p1, p2, v0}, Landroidx/profileinstaller/i;->l(Landroid/content/Context;Ljava/util/concurrent/Executor;Landroidx/profileinstaller/i$d;Z)V
...
.method static l(Landroid/content/Context;Ljava/util/concurrent/Executor;Landroidx/profileinstaller/i$d;Z)V
    .locals 9
    .param p0    # Landroid/content/Context;
        .annotation build Landroidx/annotation/o0;
        .end annotation
    ...
    .line 107
    invoke-static/range {v1 .. v7}, Landroidx/profileinstaller/i;->i(Landroid/content/res/AssetManager;Ljava/lang/String;Landroid/content/pm/PackageInfo;Ljava/io/File;Ljava/lang/String;Ljava/util/concurrent/Executor;Landroidx/profileinstaller/i$d;)Z
    ...
    .line 124
    invoke-interface {v7, p2, p1}, Landroidx/profileinstaller/i$d;->a(ILjava/lang/Object;)V
...
.method static m(Landroid/content/Context;Ljava/util/concurrent/Executor;Landroidx/profileinstaller/i$d;)V
    .locals 3
    .param p0    # Landroid/content/Context;
        .annotation build Landroidx/annotation/o0;
        .end annotation
    ...
    .line 34
    invoke-static {p1, p2, v0, p0}, Landroidx/profileinstaller/i;->h(Ljava/util/concurrent/Executor;Landroidx/profileinstaller/i$d;ILjava/lang/Object;)V
