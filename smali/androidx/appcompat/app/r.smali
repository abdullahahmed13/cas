...
.field private static final i:Landroidx/collection/o2;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    .line 63
    .line 64
    sput-object v0, Landroidx/appcompat/app/r;->i:Landroidx/collection/o2;
...
.method private a(Landroid/content/Context;Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    .line 25
    invoke-static {p2, v2}, Landroidx/core/view/l1;->G1(Landroid/view/View;Z)V
    ...
    .line 47
    invoke-static {p2, v2}, Landroidx/core/view/l1;->I1(Landroid/view/View;Ljava/lang/CharSequence;)V
    ...
    .line 69
    invoke-static {p2, p3}, Landroidx/core/view/l1;->v2(Landroid/view/View;Z)V
...
.method private s(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    .line 1
    sget-object v0, Landroidx/appcompat/app/r;->i:Landroidx/collection/o2;

    .line 2
    .line 3
    invoke-virtual {v0, p2}, Landroidx/collection/o2;->get(Ljava/lang/Object;)Ljava/lang/Object;
...
.method private t(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    .line 40
    .line 41
    invoke-direct {p0, p1, p2, v3}, Landroidx/appcompat/app/r;->s(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    :cond_3
    :try_start_1
    invoke-direct {p0, p1, p2, v1}, Landroidx/appcompat/app/r;->s(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
...
.method public final r(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    .line 218
    :pswitch_0
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/r;->d(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatButton;
    ...
    .line 222
    invoke-direct {p0, p5, p2}, Landroidx/appcompat/app/r;->v(Landroid/view/View;Ljava/lang/String;)V
    ...
    .line 227
    :pswitch_1
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/r;->g(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatEditText;
    ...
    .line 235
    :pswitch_2
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/r;->e(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatCheckBox;
    ...
    .line 243
    :pswitch_3
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/r;->c(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatAutoCompleteTextView;
    ...
    .line 259
    :pswitch_5
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/r;->p(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatToggleButton;
    ...
    .line 267
    :pswitch_6
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/r;->k(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatRadioButton;
    ...
    .line 283
    :pswitch_8
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/r;->m(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatSeekBar;
    ...
    .line 291
    :pswitch_9
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/r;->h(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatImageButton;
    ...
    .line 299
    :pswitch_a
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/r;->o(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatTextView;
    ...
    .line 307
    :pswitch_b
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/r;->j(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatMultiAutoCompleteTextView;
    ...
    .line 315
    :pswitch_c
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/r;->f(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatCheckedTextView;
    ...
    .line 323
    :pswitch_d
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/r;->l(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatRatingBar;
    ...
    .line 333
    .line 334
    invoke-direct {p0, p1, p2, p4}, Landroidx/appcompat/app/r;->t(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    .line 339
    .line 340
    invoke-direct {p0, p5, p4}, Landroidx/appcompat/app/r;->b(Landroid/view/View;Landroid/util/AttributeSet;)V

    .line 341
    .line 342
    .line 343
    invoke-direct {p0, p1, p5, p4}, Landroidx/appcompat/app/r;->a(Landroid/content/Context;Landroid/view/View;Landroid/util/AttributeSet;)V
