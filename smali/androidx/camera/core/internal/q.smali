.class public Landroidx/camera/core/internal/q;
...
.field private final e:Landroidx/camera/core/internal/r;


# direct methods
.method public constructor <init>(Landroidx/camera/core/impl/n0;Landroid/util/Size;)V
    .locals 1
    ...
    .line 3
    .line 4
    iput-object p1, p0, Landroidx/camera/core/internal/q;->a:Landroidx/camera/core/impl/n0;

    .line 5
    .line 6
    invoke-interface {p1}, Landroidx/camera/core/x;->d1()I
    ...
    .line 10
    iput v0, p0, Landroidx/camera/core/internal/q;->b:I
    ...
    .line 16
    iput v0, p0, Landroidx/camera/core/internal/q;->c:I
    ...
    .line 19
    .line 20
    invoke-direct {p0, p2}, Landroidx/camera/core/internal/q;->h(Landroid/util/Size;)Landroid/util/Rational;
    ...
    .line 25
    :cond_0
    invoke-direct {p0, p1}, Landroidx/camera/core/internal/q;->i(Landroidx/camera/core/impl/n0;)Landroid/util/Rational;
    ...
    .line 29
    :goto_0
    iput-object p2, p0, Landroidx/camera/core/internal/q;->d:Landroid/util/Rational;

    .line 30
    .line 31
    new-instance v0, Landroidx/camera/core/internal/r;

    .line 32
    .line 33
    invoke-direct {v0, p1, p2}, Landroidx/camera/core/internal/r;-><init>(Landroidx/camera/core/impl/n0;Landroid/util/Rational;)V

    .line 34
    .line 35
    .line 36
    iput-object v0, p0, Landroidx/camera/core/internal/q;->e:Landroidx/camera/core/internal/r;
...
.method private static a(Ljava/util/List;Landroidx/camera/core/resolutionselector/a;Landroid/util/Rational;)Ljava/util/LinkedHashMap;
    ...
    .line 1
    invoke-static {p0}, Landroidx/camera/core/internal/q;->o(Ljava/util/List;)Ljava/util/Map;
    ...
    .line 5
    invoke-static {p0, p1, p2}, Landroidx/camera/core/internal/q;->b(Ljava/util/Map;Landroidx/camera/core/resolutionselector/a;Landroid/util/Rational;)Ljava/util/LinkedHashMap;
...
.method private static b(Ljava/util/Map;Landroidx/camera/core/resolutionselector/a;Landroid/util/Rational;)Ljava/util/LinkedHashMap;
    ...
    .line 20
    invoke-static {v1, v0}, Landroidx/camera/core/internal/q;->n(IZ)Landroid/util/Rational;
    ...
    .line 34
    invoke-static {p1, v0}, Landroidx/camera/core/internal/q;->n(IZ)Landroid/util/Rational;
...
.method private c(Ljava/util/List;Landroidx/camera/core/resolutionselector/c;I)Ljava/util/List;
    ...
    .line 15
    .line 16
    iget-object p1, p0, Landroidx/camera/core/internal/q;->a:Landroidx/camera/core/impl/n0;

    .line 17
    .line 18
    invoke-interface {p1, p3}, Landroidx/camera/core/impl/n0;->l1(I)Ljava/util/List;
...
.method private static f(Ljava/util/LinkedHashMap;Landroidx/camera/core/resolutionselector/d;)V
    ...
    .line 29
    .line 30
    invoke-static {v1, p1}, Landroidx/camera/core/internal/q;->g(Ljava/util/List;Landroidx/camera/core/resolutionselector/d;)V
...
.method private static g(Ljava/util/List;Landroidx/camera/core/resolutionselector/d;)V
    ...
    .line 41
    :cond_2
    invoke-static {p0, p1, v3}, Landroidx/camera/core/internal/q;->r(Ljava/util/List;Landroid/util/Size;Z)V
    ...
    .line 45
    :cond_3
    invoke-static {p0, p1, v1}, Landroidx/camera/core/internal/q;->r(Ljava/util/List;Landroid/util/Size;Z)V
    ...
    .line 49
    :cond_4
    invoke-static {p0, p1, v3}, Landroidx/camera/core/internal/q;->q(Ljava/util/List;Landroid/util/Size;Z)V
    ...
    .line 53
    :cond_5
    invoke-static {p0, p1, v1}, Landroidx/camera/core/internal/q;->q(Ljava/util/List;Landroid/util/Size;Z)V
    ...
    .line 57
    :cond_6
    invoke-static {p0, p1}, Landroidx/camera/core/internal/q;->s(Ljava/util/List;Landroid/util/Size;)V
...
.method private i(Landroidx/camera/core/impl/n0;)Landroid/util/Rational;
    .locals 2
    ...
    .line 2
    .line 3
    invoke-interface {p1, v0}, Landroidx/camera/core/impl/n0;->r1(I)Ljava/util/List;
...
.method private j(Ljava/util/List;I)Ljava/util/List;
    ...
    .line 1
    invoke-direct {p0, p1, p2}, Landroidx/camera/core/internal/q;->l(Ljava/util/List;I)Ljava/util/List;
...
.method static n(IZ)Landroid/util/Rational;
    ...
    .line 27
    .line 28
    invoke-static {p1, p0}, Landroidx/camera/core/t2;->c(Ljava/lang/String;Ljava/lang/String;)V
...
.method static o(Ljava/util/List;)Ljava/util/Map;
    ...
    .line 5
    .line 6
    invoke-static {p0}, Landroidx/camera/core/internal/q;->k(Ljava/util/List;)Ljava/util/List;
...
.method public static p(Landroidx/camera/core/resolutionselector/c;Ljava/util/List;Landroid/util/Size;ILandroid/util/Rational;II)Ljava/util/List;
    ...
    .line 5
    invoke-static {p1, v0, p4}, Landroidx/camera/core/internal/q;->a(Ljava/util/List;Landroidx/camera/core/resolutionselector/a;Landroid/util/Rational;)Ljava/util/LinkedHashMap;
    ...
    .line 10
    .line 11
    invoke-static {p1, p2}, Landroidx/camera/core/internal/q;->d(Ljava/util/LinkedHashMap;Landroid/util/Size;)V
    ...
    .line 18
    invoke-static {p1, p2}, Landroidx/camera/core/internal/q;->f(Ljava/util/LinkedHashMap;Landroidx/camera/core/resolutionselector/d;)V
    ...
    .line 76
    invoke-static {p2, p0, p3, p5, p6}, Landroidx/camera/core/internal/q;->e(Ljava/util/List;Landroidx/camera/core/resolutionselector/b;III)Ljava/util/List;
...
# virtual methods
.method public m(Landroidx/camera/core/impl/r4;)Ljava/util/List;
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 5
    invoke-interface {v0, v1}, Landroidx/camera/core/impl/p2;->G(Ljava/util/List;)Ljava/util/List;
    ...
    .line 16
    invoke-interface {v0, v1}, Landroidx/camera/core/impl/p2;->n(Ljava/util/List;)Ljava/util/List;
    ...
    .line 24
    invoke-direct {p0, v3, v4}, Landroidx/camera/core/internal/q;->j(Ljava/util/List;I)Ljava/util/List;
    ...
    .line 29
    .line 30
    iget-object v0, p0, Landroidx/camera/core/internal/q;->e:Landroidx/camera/core/internal/r;

    .line 31
    .line 32
    invoke-virtual {v0, v3, p1}, Landroidx/camera/core/internal/r;->f(Ljava/util/List;Landroidx/camera/core/impl/r4;)Ljava/util/List;
    ...
    .line 38
    check-cast v4, Landroidx/camera/core/impl/p2;

    .line 39
    .line 40
    invoke-interface {v4, v1}, Landroidx/camera/core/impl/p2;->l(Landroid/util/Size;)Landroid/util/Size;
    ...
    .line 49
    invoke-interface {p1, v1}, Landroidx/camera/core/impl/r4;->Q(Z)Z
    ...
    .line 59
    invoke-direct {p0, v3, v2, v1}, Landroidx/camera/core/internal/q;->c(Ljava/util/List;Landroidx/camera/core/resolutionselector/c;I)Ljava/util/List;
    ...
    .line 93
    .line 94
    invoke-interface {v0}, Landroidx/camera/core/impl/p2;->V()Landroidx/camera/core/resolutionselector/c;
    ...
    .line 98
    iget-object v9, p0, Landroidx/camera/core/internal/q;->d:Landroid/util/Rational;

    .line 99
    .line 100
    iget v10, p0, Landroidx/camera/core/internal/q;->b:I

    .line 101
    .line 102
    iget v11, p0, Landroidx/camera/core/internal/q;->c:I

    .line 103
    .line 104
    invoke-static/range {v5 .. v11}, Landroidx/camera/core/internal/q;->p(Landroidx/camera/core/resolutionselector/c;Ljava/util/List;Landroid/util/Size;ILandroid/util/Rational;II)Ljava/util/List;
