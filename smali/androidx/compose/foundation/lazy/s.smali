...
.method private constructor <init>(Landroidx/compose/foundation/lazy/t;IZFLandroidx/compose/ui/layout/s0;FZLkotlinx/coroutines/s0;Landroidx/compose/ui/unit/d;JLjava/util/List;IIIZLandroidx/compose/foundation/gestures/j0;II)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    iput-object p1, p0, Landroidx/compose/foundation/lazy/s;->a:Landroidx/compose/foundation/lazy/t;

    .line 4
    iput p2, p0, Landroidx/compose/foundation/lazy/s;->b:I

    .line 5
    iput-boolean p3, p0, Landroidx/compose/foundation/lazy/s;->c:Z

    .line 6
    iput p4, p0, Landroidx/compose/foundation/lazy/s;->d:F

    .line 7
    iput p6, p0, Landroidx/compose/foundation/lazy/s;->e:F

    .line 8
    iput-boolean p7, p0, Landroidx/compose/foundation/lazy/s;->f:Z

    .line 9
    iput-object p8, p0, Landroidx/compose/foundation/lazy/s;->g:Lkotlinx/coroutines/s0;

    .line 10
    iput-object p9, p0, Landroidx/compose/foundation/lazy/s;->h:Landroidx/compose/ui/unit/d;

    .line 11
    iput-wide p10, p0, Landroidx/compose/foundation/lazy/s;->i:J

    .line 12
    iput-object p12, p0, Landroidx/compose/foundation/lazy/s;->j:Ljava/util/List;

    .line 13
    iput p13, p0, Landroidx/compose/foundation/lazy/s;->k:I

    .line 14
    iput p14, p0, Landroidx/compose/foundation/lazy/s;->l:I

    .line 15
    iput p15, p0, Landroidx/compose/foundation/lazy/s;->m:I

    move/from16 p1, p16

    .line 16
    iput-boolean p1, p0, Landroidx/compose/foundation/lazy/s;->n:Z

    move-object/from16 p1, p17

    .line 17
    iput-object p1, p0, Landroidx/compose/foundation/lazy/s;->o:Landroidx/compose/foundation/gestures/j0;

    move/from16 p1, p18

    .line 18
    iput p1, p0, Landroidx/compose/foundation/lazy/s;->p:I

    move/from16 p1, p19

    .line 19
    iput p1, p0, Landroidx/compose/foundation/lazy/s;->q:I

    .line 20
    iput-object p5, p0, Landroidx/compose/foundation/lazy/s;->r:Landroidx/compose/ui/layout/s0;

    return-void
.end method

.method public synthetic constructor <init>(Landroidx/compose/foundation/lazy/t;IZFLandroidx/compose/ui/layout/s0;FZLkotlinx/coroutines/s0;Landroidx/compose/ui/unit/d;JLjava/util/List;IIIZLandroidx/compose/foundation/gestures/j0;IILkotlin/jvm/internal/DefaultConstructorMarker;)V
    .locals 0

    .line 1
    invoke-direct/range {p0 .. p19}, Landroidx/compose/foundation/lazy/s;-><init>(Landroidx/compose/foundation/lazy/t;IZFLandroidx/compose/ui/layout/s0;FZLkotlinx/coroutines/s0;Landroidx/compose/ui/unit/d;JLjava/util/List;IIIZLandroidx/compose/foundation/gestures/j0;II)V
...
.method public final D(IZ)Z
    ...
    .line 5
    .line 6
    invoke-virtual {p0}, Landroidx/compose/foundation/lazy/s;->i()Ljava/util/List;
    ...
    .line 50
    .line 51
    invoke-virtual {v0}, Landroidx/compose/foundation/lazy/t;->g()Z
    ...
    .line 56
    .line 57
    invoke-virtual {v2}, Landroidx/compose/foundation/lazy/t;->g()Z
    ...
    .line 65
    .line 66
    invoke-virtual {v0}, Landroidx/compose/foundation/lazy/t;->getOffset()I
    ...
    .line 80
    invoke-virtual {v2}, Landroidx/compose/foundation/lazy/t;->getOffset()I
    ...
    .line 89
    invoke-virtual {p0}, Landroidx/compose/foundation/lazy/s;->e()I
...
.method public final u()Lkotlinx/coroutines/s0;
    .locals 1
    .annotation build Lqi/l;
    .end annotation

    .line 1
    iget-object v0, p0, Landroidx/compose/foundation/lazy/s;->g:Lkotlinx/coroutines/s0;
