.class final Landroidx/compose/material3/p4$h;
...
# direct methods
.method constructor <init>(Landroidx/compose/material3/n4;ZZLeg/p;ZLeg/p;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    iput-object p1, p0, Landroidx/compose/material3/p4$h;->f:Landroidx/compose/material3/n4;

    .line 2
    .line 3
    iput-boolean p2, p0, Landroidx/compose/material3/p4$h;->g:Z

    .line 4
    .line 5
    iput-boolean p3, p0, Landroidx/compose/material3/p4$h;->h:Z

    .line 6
    .line 7
    iput-object p4, p0, Landroidx/compose/material3/p4$h;->i:Leg/p;

    .line 8
    .line 9
    iput-boolean p5, p0, Landroidx/compose/material3/p4$h;->j:Z

    .line 10
    .line 11
    iput-object p6, p0, Landroidx/compose/material3/p4$h;->k:Leg/p;
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/compose/material3/p4$h;->invoke(Landroidx/compose/runtime/w;I)V
...
.method public final invoke(Landroidx/compose/runtime/w;I)V
    ...
    .line 5
    :cond_2
    iget-object p2, p0, Landroidx/compose/material3/p4$h;->f:Landroidx/compose/material3/n4;

    iget-boolean v0, p0, Landroidx/compose/material3/p4$h;->g:Z

    iget-boolean v1, p0, Landroidx/compose/material3/p4$h;->h:Z

    invoke-virtual {p2, v0, v1}, Landroidx/compose/material3/n4;->k(ZZ)J
    ...
    .line 6
    invoke-static {p2, v1, v4, v0, v4}, Landroidx/compose/animation/core/l;->t(IILandroidx/compose/animation/core/i0;ILjava/lang/Object;)Landroidx/compose/animation/core/o2;
    ...
    .line 8
    iget-object p2, p0, Landroidx/compose/material3/p4$h;->i:Leg/p;

    if-eqz p2, :cond_4

    iget-boolean p2, p0, Landroidx/compose/material3/p4$h;->j:Z

    if-nez p2, :cond_3

    iget-boolean p2, p0, Landroidx/compose/material3/p4$h;->g:Z
    ...
    sget-object v0, Landroidx/compose/material3/p4$h$a;->f:Landroidx/compose/material3/p4$h$a;

    invoke-static {p2, v0}, Landroidx/compose/ui/semantics/o;->c(Landroidx/compose/ui/q;Leg/l;)Landroidx/compose/ui/q;
    ...
    :goto_1
    iget-object v0, p0, Landroidx/compose/material3/p4$h;->k:Leg/p;
    ...
    .line 11
    invoke-static {v2, v1}, Landroidx/compose/foundation/layout/l;->j(Landroidx/compose/ui/c;Z)Landroidx/compose/ui/layout/r0;

    move-result-object v2

    .line 12
    invoke-static {v7, v1}, Landroidx/compose/runtime/r;->j(Landroidx/compose/runtime/w;I)I
    ...
    .line 14
    invoke-static {v7, p2}, Landroidx/compose/ui/i;->n(Landroidx/compose/runtime/w;Landroidx/compose/ui/q;)Landroidx/compose/ui/q;
    ...
    .line 19
    invoke-interface {v7, v5}, Landroidx/compose/runtime/w;->l0(Leg/a;)V
    ...
    invoke-static {v5, v3, v2}, Landroidx/compose/runtime/y5;->j(Landroidx/compose/runtime/w;Ljava/lang/Object;Leg/p;)V
    ...
    invoke-static {p1}, Landroidx/compose/material3/p4$h;->a(Landroidx/compose/runtime/n5;)J
    ...
    invoke-virtual {p2, p1}, Landroidx/compose/runtime/i3;->f(Ljava/lang/Object;)Landroidx/compose/runtime/j3;

    move-result-object p1

    sget p2, Landroidx/compose/runtime/j3;->i:I

    invoke-static {p1, v0, v7, p2}, Landroidx/compose/runtime/i0;->b(Landroidx/compose/runtime/j3;Leg/p;Landroidx/compose/runtime/w;I)V
