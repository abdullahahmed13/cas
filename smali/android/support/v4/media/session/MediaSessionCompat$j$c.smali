...
# instance fields
.field final synthetic o0:Landroid/support/v4/media/session/MediaSessionCompat$j;
...
.method constructor <init>(Landroid/support/v4/media/session/MediaSessionCompat$j;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$j$c;->o0:Landroid/support/v4/media/session/MediaSessionCompat$j;
...
.method public A0(Z)V
    ...
    .line 7
    invoke-virtual {p0, v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$j$c;->T8(ILjava/lang/Object;)V
...
.method public B6(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 2
    .line 3
    invoke-virtual {p0, v0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$j$c;->V9(ILjava/lang/Object;Landroid/os/Bundle;)V
...
.method C0(I)V
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$j$c;->o0:Landroid/support/v4/media/session/MediaSessionCompat$j;
...
.method public E()J
    ...
    .line 6
    :try_start_0
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$j$c;->o0:Landroid/support/v4/media/session/MediaSessionCompat$j;
...
.method public E5()Landroid/support/v4/media/session/ParcelableVolumeInfo;
    .locals 8
    ...
    .line 2
    .line 3
    iget-object v1, v0, Landroid/support/v4/media/session/MediaSessionCompat$j;->j:Ljava/lang/Object;
    ...
    .line 7
    .line 8
    iget v3, v0, Landroid/support/v4/media/session/MediaSessionCompat$j;->D:I

    .line 9
    .line 10
    iget v4, v0, Landroid/support/v4/media/session/MediaSessionCompat$j;->E:I

    .line 11
    .line 12
    iget-object v2, v0, Landroid/support/v4/media/session/MediaSessionCompat$j;->F:Landroidx/media/m;
    ...
    .line 16
    .line 17
    invoke-virtual {v2}, Landroidx/media/m;->c()I
    ...
    .line 21
    invoke-virtual {v2}, Landroidx/media/m;->b()I
    ...
    .line 25
    invoke-virtual {v2}, Landroidx/media/m;->a()I
    ...
    .line 34
    :cond_0
    iget-object v0, v0, Landroid/support/v4/media/session/MediaSessionCompat$j;->h:Landroid/media/AudioManager;
    ...
    .line 40
    iget-object v2, p0, Landroid/support/v4/media/session/MediaSessionCompat$j$c;->o0:Landroid/support/v4/media/session/MediaSessionCompat$j;
...
.method public G0()V
    ...
    .line 2
    invoke-virtual {p0, v0}, Landroid/support/v4/media/session/MediaSessionCompat$j$c;->C0(I)V
...
.method public I2(Landroid/support/v4/media/RatingCompat;Landroid/os/Bundle;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public J1()Landroid/app/PendingIntent;
    .locals 2
...
.method public J6(Landroid/net/Uri;Landroid/os/Bundle;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public N3(Landroid/support/v4/media/session/a;)V
    ...
    .line 7
    :try_start_0
    invoke-interface {p1}, Landroid/support/v4/media/session/a;->e0()V
    :try_end_0
    ...
    .line 22
    .line 23
    invoke-direct {v0, v3, v1, v2}, Landroidx/media/g$b;-><init>(Ljava/lang/String;II)V
...
.method T8(ILjava/lang/Object;)V
    .locals 6
...
.method U9(ILjava/lang/Object;I)V
    .locals 6
...
.method V9(ILjava/lang/Object;Landroid/os/Bundle;)V
    .locals 6
...
.method public X6(Landroid/view/KeyEvent;)Z
    .locals 2
...
.method public b1(Landroid/support/v4/media/MediaDescriptionCompat;)V
    .locals 1
...
.method public c1(Landroid/support/v4/media/MediaDescriptionCompat;)V
    .locals 1
...
.method public c8(Landroid/support/v4/media/RatingCompat;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public d8(IILjava/lang/String;)V
    .locals 0

    .line 1
    iget-object p3, p0, Landroid/support/v4/media/session/MediaSessionCompat$j$c;->o0:Landroid/support/v4/media/session/MediaSessionCompat$j;

    .line 2
    .line 3
    invoke-virtual {p3, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$j;->M(II)V
...
.method public d9(IILjava/lang/String;)V
    .locals 0
...
.method public e7(Landroid/support/v4/media/MediaDescriptionCompat;I)V
    .locals 1
    ...
    .line 2
    .line 3
    invoke-virtual {p0, v0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$j$c;->U9(ILjava/lang/Object;I)V
...
.method public i3(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/session/MediaSessionCompat$ResultReceiverWrapper;)V
    .locals 1
    ...
    .line 9
    invoke-virtual {p0, p1, v0}, Landroid/support/v4/media/session/MediaSessionCompat$j$c;->T8(ILjava/lang/Object;)V
...
.method public l8(Ljava/lang/String;Landroid/os/Bundle;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public u()Landroid/support/v4/media/MediaMetadataCompat;
    .locals 1
...
.method public x1(Landroid/net/Uri;Landroid/os/Bundle;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public x4(Landroid/support/v4/media/session/a;)V
    .locals 1
