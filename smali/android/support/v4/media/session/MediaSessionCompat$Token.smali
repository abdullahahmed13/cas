...
.method constructor <init>(Ljava/lang/Object;Landroid/support/v4/media/session/b;Landroid/os/Bundle;)V
    ...
    .line 6
    iput-object p3, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->f:Landroid/os/Bundle;
...
.method public static a(Landroid/os/Bundle;)Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    .line 6
    .line 7
    invoke-static {p0, v1}, Landroidx/core/app/l;->a(Landroid/os/Bundle;Ljava/lang/String;)Landroid/os/IBinder;
    ...
    .line 11
    invoke-static {v1}, Landroid/support/v4/media/session/b$a;->n0(Landroid/os/IBinder;)Landroid/support/v4/media/session/b;
...
.method public h()Landroid/support/v4/media/session/b;
    .locals 1
    .annotation build Landroidx/annotation/c1;
        value = {
            .enum Landroidx/annotation/c1$a;->LIBRARY_GROUP:Landroidx/annotation/c1$a;
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->e:Landroid/support/v4/media/session/b;
...
.method public j()Landroid/os/Bundle;
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->f:Landroid/os/Bundle;
...
.method public l(Landroid/support/v4/media/session/b;)V
    .locals 0
    .annotation build Landroidx/annotation/c1;
        value = {
            .enum Landroidx/annotation/c1$a;->LIBRARY_GROUP:Landroidx/annotation/c1$a;
...
.method public m(Landroid/os/Bundle;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->f:Landroid/os/Bundle;
...
.method public n()Landroid/os/Bundle;
    ...
    .line 21
    invoke-static {v0, v2, v1}, Landroidx/core/app/l;->b(Landroid/os/Bundle;Ljava/lang/String;Landroid/os/IBinder;)V

    .line 22
    .line 23
    .line 24
    :cond_0
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->f:Landroid/os/Bundle;
