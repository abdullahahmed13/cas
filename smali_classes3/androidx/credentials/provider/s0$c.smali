.class final Landroidx/credentials/provider/s0$c;
...
# static fields
.field public static final a:Landroidx/credentials/provider/s0$c;
...
.method static constructor <clinit>()V
    ...
    .line 1
    new-instance v0, Landroidx/credentials/provider/s0$c;

    .line 2
    .line 3
    invoke-direct {v0}, Landroidx/credentials/provider/s0$c;-><init>()V

    .line 4
    .line 5
    .line 6
    sput-object v0, Landroidx/credentials/provider/s0$c;->a:Landroidx/credentials/provider/s0$c;
...
.method public static final b(Landroid/app/slice/Slice;)Landroidx/credentials/provider/s0;
    ...
    .line 7
    .line 8
    invoke-static {v1}, Landroidx/credentials/provider/s0$a;->b(Landroid/app/slice/Slice;)Landroidx/credentials/provider/s0;
    ...
    :cond_2
    :try_start_0
    invoke-virtual {v0}, Landroidx/credentials/provider/s0;->s()Ljava/lang/CharSequence;
    ...
    .line 61
    invoke-virtual {v0}, Landroidx/credentials/provider/s0;->n()Ljava/lang/CharSequence;
    ...
    .line 65
    invoke-virtual {v0}, Landroidx/credentials/provider/s0;->r()Ljava/lang/CharSequence;
    ...
    .line 69
    invoke-virtual {v0}, Landroidx/credentials/provider/s0;->q()Landroid/app/PendingIntent;
    ...
    .line 73
    invoke-virtual {v0}, Landroidx/credentials/provider/s0;->p()Lj$/time/Instant;
    ...
    .line 77
    invoke-virtual {v0}, Landroidx/credentials/provider/s0;->o()Landroid/graphics/drawable/Icon;
    ...
    .line 81
    invoke-virtual {v0}, Landroidx/credentials/provider/s0;->u()Z
    ...
    .line 95
    check-cast v12, Landroidx/credentials/provider/v;
    ...
    .line 109
    invoke-virtual {v0}, Landroidx/credentials/provider/s0;->v()Z
    ...
    .line 113
    invoke-static {v0}, Landroidx/credentials/provider/s0;->k(Landroidx/credentials/provider/s0;)Z
    ...
    .line 132
    :goto_1
    new-instance v4, Landroidx/credentials/provider/s0;
...
.method public static final c(Landroidx/credentials/provider/s0;)Landroid/app/slice/Slice;
    .locals 5
    ...
    .line 27
    .line 28
    sget-object v0, Landroidx/credentials/provider/s0$c;->a:Landroidx/credentials/provider/s0$c;

    .line 29
    .line 30
    invoke-virtual {v0, p0, v1}, Landroidx/credentials/provider/s0$c;->a(Landroidx/credentials/provider/s0;Landroid/app/slice/Slice$Builder;)V
