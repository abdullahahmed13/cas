...
.method private static a(Landroidx/core/content/res/i$c;ILandroid/content/res/ColorStateList;Landroid/content/res/Resources$Theme;)V
    .locals 3
    .param p1    # I
    ...
    :cond_0
    :goto_0
    new-instance v1, Landroidx/core/content/res/i$b;

    .line 26
    .line 27
    iget-object p0, p0, Landroidx/core/content/res/i$c;->a:Landroid/content/res/Resources;
    ...
    .line 33
    invoke-direct {v1, p2, p0, p3}, Landroidx/core/content/res/i$b;-><init>(Landroid/content/res/ColorStateList;Landroid/content/res/Configuration;Landroid/content/res/Resources$Theme;)V
...
.method public static b(Landroid/content/res/Resources$Theme;)V
    ...
    .line 24
    check-cast v2, Landroidx/core/content/res/i$c;
    ...
    .line 27
    .line 28
    iget-object v2, v2, Landroidx/core/content/res/i$c;->b:Landroid/content/res/Resources$Theme;
...
.method private static c(Landroidx/core/content/res/i$c;I)Landroid/content/res/ColorStateList;
    .locals 5
    .param p1    # I
        .annotation build Landroidx/annotation/n;
        .end annotation
    ...
    .line 24
    check-cast v2, Landroidx/core/content/res/i$b;
    ...
    .line 27
    .line 28
    iget-object v3, v2, Landroidx/core/content/res/i$b;->b:Landroid/content/res/Configuration;

    .line 29
    .line 30
    iget-object v4, p0, Landroidx/core/content/res/i$c;->a:Landroid/content/res/Resources;
    ...
    .line 41
    .line 42
    iget-object p0, p0, Landroidx/core/content/res/i$c;->b:Landroid/content/res/Resources$Theme;
    ...
    .line 45
    .line 46
    iget v3, v2, Landroidx/core/content/res/i$b;->c:I
    ...
    .line 63
    :cond_1
    iget-object p0, v2, Landroidx/core/content/res/i$b;->a:Landroid/content/res/ColorStateList;
...
.method public static d(Landroid/content/Context;I)Landroid/graphics/Typeface;
    ...
    .line 21
    invoke-static/range {v0 .. v7}, Landroidx/core/content/res/i;->p(Landroid/content/Context;ILandroid/util/TypedValue;ILandroidx/core/content/res/i$d;Landroid/os/Handler;ZZ)Landroid/graphics/Typeface;
...
.method public static f(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/content/res/ColorStateList;
    ...
    .line 1
    new-instance v0, Landroidx/core/content/res/i$c;

    .line 2
    .line 3
    invoke-direct {v0, p0, p2}, Landroidx/core/content/res/i$c;-><init>(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;)V

    .line 4
    .line 5
    .line 6
    invoke-static {v0, p1}, Landroidx/core/content/res/i;->c(Landroidx/core/content/res/i$c;I)Landroid/content/res/ColorStateList;
    ...
    .line 18
    .line 19
    invoke-static {v0, p1, v1, p2}, Landroidx/core/content/res/i;->a(Landroidx/core/content/res/i$c;ILandroid/content/res/ColorStateList;Landroid/content/res/Resources$Theme;)V
...
.method public static i(Landroid/content/res/Resources;I)F
    ...
    .line 6
    .line 7
    invoke-static {p0, p1}, Landroidx/core/content/res/i$a;->a(Landroid/content/res/Resources;I)F
...
.method public static k(Landroid/content/Context;ILandroid/util/TypedValue;ILandroidx/core/content/res/i$d;)Landroid/graphics/Typeface;
    .locals 8
    .param p1    # I
        .annotation build Landroidx/annotation/y;
        .end annotation
...
.method public static l(Landroid/content/Context;ILandroidx/core/content/res/i$d;Landroid/os/Handler;)V
    .locals 8
    .param p1    # I
        .annotation build Landroidx/annotation/y;
        .end annotation
    ...
    .line 11
    invoke-virtual {p2, p0, p3}, Landroidx/core/content/res/i$d;->callbackFailAsync(ILandroid/os/Handler;)V
...
.method private static p(Landroid/content/Context;ILandroid/util/TypedValue;ILandroidx/core/content/res/i$d;Landroid/os/Handler;ZZ)Landroid/graphics/Typeface;
    .locals 9
    ...
    .line 17
    .line 18
    invoke-static/range {v0 .. v8}, Landroidx/core/content/res/i;->q(Landroid/content/Context;Landroid/content/res/Resources;Landroid/util/TypedValue;IILandroidx/core/content/res/i$d;Landroid/os/Handler;ZZ)Landroid/graphics/Typeface;
...
.method private static q(Landroid/content/Context;Landroid/content/res/Resources;Landroid/util/TypedValue;IILandroidx/core/content/res/i$d;Landroid/os/Handler;ZZ)Landroid/graphics/Typeface;
    .locals 13
    ...
    .line 28
    .line 29
    invoke-virtual {v7, v12, v8}, Landroidx/core/content/res/i$d;->callbackFailAsync(ILandroid/os/Handler;)V
    ...
    .line 36
    .line 37
    invoke-static {p1, v2, v3, v0, v5}, Landroidx/core/graphics/c0;->l(Landroid/content/res/Resources;ILjava/lang/String;II)Landroid/graphics/Typeface;
    ...
    .line 44
    .line 45
    invoke-virtual {v7, v0, v8}, Landroidx/core/content/res/i$d;->callbackSuccessAsync(Landroid/graphics/Typeface;Landroid/os/Handler;)V
    ...
    .line 68
    invoke-static {v0, p1}, Landroidx/core/content/res/f;->b(Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources;)Landroidx/core/content/res/f$a;
    ...
    .line 128
    .line 129
    invoke-virtual {v7, p0, v8}, Landroidx/core/content/res/i$d;->callbackSuccessAsync(Landroid/graphics/Typeface;Landroid/os/Handler;)V
