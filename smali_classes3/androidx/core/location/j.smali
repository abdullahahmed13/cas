...
.method public static c(Landroid/location/LocationManager;Ljava/lang/String;Landroid/os/CancellationSignal;Ljava/util/concurrent/Executor;Landroidx/core/util/e;)V
    ...
    .line 46
    :cond_2
    new-instance v6, Landroidx/core/location/j$f;

    .line 47
    .line 48
    invoke-direct {v6, p0, p3, p4}, Landroidx/core/location/j$f;-><init>(Landroid/location/LocationManager;Ljava/util/concurrent/Executor;Landroidx/core/util/e;)V
    ...
    .line 66
    .line 67
    invoke-direct {p0, v6}, Landroidx/core/location/h;-><init>(Landroidx/core/location/j$f;)V
    ...
    .line 74
    .line 75
    invoke-virtual {v6, p0, p1}, Landroidx/core/location/j$f;->e(J)V
...
.method public static d(Landroid/location/LocationManager;Ljava/lang/String;Landroidx/core/os/g;Ljava/util/concurrent/Executor;Landroidx/core/util/e;)V
    .locals 0
    .annotation build Landroidx/annotation/b1;
        anyOf = {
            "android.permission.ACCESS_COARSE_LOCATION",
    ...
    .line 2
    .line 3
    invoke-virtual {p2}, Landroidx/core/os/g;->b()Ljava/lang/Object;
...
.method public static i(Landroid/location/LocationManager;Landroid/location/GnssMeasurementsEvent$Callback;Landroid/os/Handler;)Z
    .locals 2
    .annotation build Landroidx/annotation/b1;
    ...
    .line 13
    .line 14
    invoke-static {p2}, Landroidx/core/os/k;->a(Landroid/os/Handler;)Ljava/util/concurrent/Executor;
    ...
    .line 18
    invoke-static {p0, p2, p1}, Landroidx/core/location/j;->k(Landroid/location/LocationManager;Ljava/util/concurrent/Executor;Landroid/location/GnssMeasurementsEvent$Callback;)Z
    ...
    .line 23
    :cond_1
    sget-object v0, Landroidx/core/location/j$g;->b:Landroidx/collection/o2;
    ...
    .line 26
    :try_start_0
    invoke-static {p0, p1}, Landroidx/core/location/j;->s(Landroid/location/LocationManager;Landroid/location/GnssMeasurementsEvent$Callback;)V
    ...
    .line 34
    .line 35
    invoke-virtual {v0, p1, p1}, Landroidx/collection/o2;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static j(Landroid/location/LocationManager;Ljava/util/concurrent/Executor;Landroid/location/GnssMeasurementsEvent$Callback;)Z
    ...
    .line 13
    .line 14
    invoke-static {p0, p1, p2}, Landroidx/core/location/j;->k(Landroid/location/LocationManager;Ljava/util/concurrent/Executor;Landroid/location/GnssMeasurementsEvent$Callback;)Z
    ...
    .line 26
    .line 27
    invoke-static {p0, p2}, Landroidx/core/location/j;->s(Landroid/location/LocationManager;Landroid/location/GnssMeasurementsEvent$Callback;)V
    ...
    .line 35
    .line 36
    invoke-virtual {v0, p2, v1}, Landroidx/collection/o2;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static k(Landroid/location/LocationManager;Ljava/util/concurrent/Executor;Landroid/location/GnssMeasurementsEvent$Callback;)Z
    .locals 8
    .annotation build Landroidx/annotation/x0;
        value = 0x1e
    .end annotation
...
.method private static l(Landroid/location/LocationManager;Landroid/os/Handler;Ljava/util/concurrent/Executor;Landroidx/core/location/a$a;)Z
    .locals 2
    .annotation build Landroidx/annotation/b1;
        value = "android.permission.ACCESS_FINE_LOCATION"
    .end annotation
...
.method public static m(Landroid/location/LocationManager;Landroidx/core/location/a$a;Landroid/os/Handler;)Z
    .locals 2
    .annotation build Landroidx/annotation/b1;
        value = "android.permission.ACCESS_FINE_LOCATION"
    .end annotation
    ...
    .line 11
    invoke-static {p0, p2, p1}, Landroidx/core/location/j;->n(Landroid/location/LocationManager;Ljava/util/concurrent/Executor;Landroidx/core/location/a$a;)Z
    ...
    .line 20
    .line 21
    invoke-static {p0, v0, p1}, Landroidx/core/location/j;->n(Landroid/location/LocationManager;Ljava/util/concurrent/Executor;Landroidx/core/location/a$a;)Z
...
.method public static n(Landroid/location/LocationManager;Ljava/util/concurrent/Executor;Landroidx/core/location/a$a;)Z
    .locals 2
    .annotation build Landroidx/annotation/b1;
        value = "android.permission.ACCESS_FINE_LOCATION"
    .end annotation
    ...
    .line 8
    invoke-static {p0, v0, p1, p2}, Landroidx/core/location/j;->l(Landroid/location/LocationManager;Landroid/os/Handler;Ljava/util/concurrent/Executor;Landroidx/core/location/a$a;)Z
    ...
    .line 27
    .line 28
    invoke-static {p0, v1, p1, p2}, Landroidx/core/location/j;->l(Landroid/location/LocationManager;Landroid/os/Handler;Ljava/util/concurrent/Executor;Landroidx/core/location/a$a;)Z
...
.method static o(Landroid/location/LocationManager;Landroidx/core/location/j$m;)V
    .locals 3
    .annotation build Landroidx/annotation/b0;
        value = "sLocationListeners"
    .end annotation
    ...
    .line 29
    .line 30
    invoke-virtual {p1}, Landroidx/core/location/j$m;->h()V
...
.method public static p(Landroid/location/LocationManager;Landroidx/core/location/f;)V
    .locals 6
    .annotation build Landroidx/annotation/b1;
        anyOf = {
            "android.permission.ACCESS_COARSE_LOCATION",
    ...
    .line 54
    .line 55
    invoke-virtual {v3}, Landroidx/core/location/j$m;->h()V
...
.method public static q(Landroid/location/LocationManager;Ljava/lang/String;Landroidx/core/location/e0;Landroidx/core/location/f;Landroid/os/Looper;)V
    .locals 8
    .annotation build Landroidx/annotation/b1;
        anyOf = {
            "android.permission.ACCESS_COARSE_LOCATION",
    ...
    .line 6
    .line 7
    invoke-virtual {p2}, Landroidx/core/location/e0;->h()Landroid/location/LocationRequest;
    ...
    .line 31
    :cond_1
    invoke-virtual {p2}, Landroidx/core/location/e0;->b()J
    ...
    .line 35
    invoke-virtual {p2}, Landroidx/core/location/e0;->e()F
...
.method public static r(Landroid/location/LocationManager;Ljava/lang/String;Landroidx/core/location/e0;Ljava/util/concurrent/Executor;Landroidx/core/location/f;)V
    .locals 8
    .annotation build Landroidx/annotation/b1;
        anyOf = {
            "android.permission.ACCESS_COARSE_LOCATION",
    ...
    .line 26
    :cond_1
    new-instance v6, Landroidx/core/location/j$m;

    .line 27
    .line 28
    new-instance v0, Landroidx/core/location/j$l;

    .line 29
    .line 30
    invoke-direct {v0, p1, p4}, Landroidx/core/location/j$l;-><init>(Ljava/lang/String;Landroidx/core/location/f;)V

    .line 31
    .line 32
    .line 33
    invoke-direct {v6, v0, p3}, Landroidx/core/location/j$m;-><init>(Landroidx/core/location/j$l;Ljava/util/concurrent/Executor;)V

    .line 34
    .line 35
    .line 36
    invoke-static {p0, p1, p2, v6}, Landroidx/core/location/j$a;->b(Landroid/location/LocationManager;Ljava/lang/String;Landroidx/core/location/e0;Landroidx/core/location/j$m;)Z
    ...
    .line 62
    .line 63
    invoke-static {v1, v6}, Landroidx/core/location/j;->o(Landroid/location/LocationManager;Landroidx/core/location/j$m;)V
...
.method public static s(Landroid/location/LocationManager;Landroid/location/GnssMeasurementsEvent$Callback;)V
    .locals 2
    .annotation build Landroidx/annotation/x0;
        value = 0x18
    .end annotation
    ...
    .line 28
    .line 29
    invoke-virtual {v1}, Landroidx/core/location/j$h;->c()V
...
.method public static t(Landroid/location/LocationManager;Landroidx/core/location/a$a;)V
    .locals 1

    .line 1
    sget-object v0, Landroidx/core/location/j$g;->a:Landroidx/collection/o2;
