...
.method public static B(Landroid/widget/TextView;IF)V
    ...
    .line 6
    .line 7
    invoke-static {p0, p1, p2}, Landroidx/core/widget/r$d;->a(Landroid/widget/TextView;IF)V
...
.method public static C(Landroid/widget/TextView;Landroidx/core/text/i;)V
    .locals 2
    ...
    .line 6
    .line 7
    invoke-virtual {p1}, Landroidx/core/text/i;->f()Landroid/text/PrecomputedText;
    ...
    .line 11
    invoke-static {p1}, Landroidx/core/widget/r$c;->a(Landroid/text/PrecomputedText;)Ljava/lang/CharSequence;
    ...
    .line 19
    :cond_0
    invoke-static {p0}, Landroidx/core/widget/r;->o(Landroid/widget/TextView;)Landroidx/core/text/i$b;
    ...
    .line 23
    invoke-virtual {p1}, Landroidx/core/text/i;->e()Landroidx/core/text/i$b;
    ...
    .line 27
    invoke-virtual {v0, v1}, Landroidx/core/text/i$b;->a(Landroidx/core/text/i$b;)Z
...
.method public static E(Landroid/widget/TextView;Landroidx/core/text/i$b;)V
    .locals 2

    .line 1
    invoke-virtual {p1}, Landroidx/core/text/i$b;->d()Landroid/text/TextDirectionHeuristic;
    ...
    .line 16
    invoke-virtual {p1}, Landroidx/core/text/i$b;->e()Landroid/text/TextPaint;
    ...
    .line 22
    .line 23
    invoke-virtual {p1}, Landroidx/core/text/i$b;->b()I
    ...
    .line 29
    .line 30
    invoke-virtual {p1}, Landroidx/core/text/i$b;->c()I
...
.method public static F(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode$Callback;
    ...
    .line 1
    instance-of v0, p0, Landroidx/core/widget/r$f;
    ...
    .line 10
    .line 11
    check-cast p0, Landroidx/core/widget/r$f;

    .line 12
    .line 13
    invoke-virtual {p0}, Landroidx/core/widget/r$f;->d()Landroid/view/ActionMode$Callback;
...
.method public static G(Landroid/widget/TextView;Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode$Callback;
    ...
    .line 10
    .line 11
    instance-of v0, p1, Landroidx/core/widget/r$f;
    ...
    .line 18
    :cond_0
    new-instance v0, Landroidx/core/widget/r$f;

    .line 19
    .line 20
    invoke-direct {v0, p1, p0}, Landroidx/core/widget/r$f;-><init>(Landroid/view/ActionMode$Callback;Landroid/widget/TextView;)V
...
.method public static a(Landroid/widget/TextView;)I
    ...
    .line 6
    .line 7
    invoke-static {p0}, Landroidx/core/widget/r$b;->a(Landroid/widget/TextView;)I
...
.method public static b(Landroid/widget/TextView;)I
    ...
    .line 6
    .line 7
    invoke-static {p0}, Landroidx/core/widget/r$b;->b(Landroid/widget/TextView;)I
...
.method public static c(Landroid/widget/TextView;)I
    ...
    .line 6
    .line 7
    invoke-static {p0}, Landroidx/core/widget/r$b;->c(Landroid/widget/TextView;)I
...
.method public static d(Landroid/widget/TextView;)[I
    ...
    .line 6
    .line 7
    invoke-static {p0}, Landroidx/core/widget/r$b;->d(Landroid/widget/TextView;)[I
...
.method public static e(Landroid/widget/TextView;)I
    ...
    .line 6
    .line 7
    invoke-static {p0}, Landroidx/core/widget/r$b;->e(Landroid/widget/TextView;)I
...
.method private static n(Landroid/widget/TextView;)Landroid/text/TextDirectionHeuristic;
    ...
    .line 33
    invoke-static {p0}, Landroidx/core/widget/r$a;->a(Ljava/util/Locale;)Landroid/icu/text/DecimalFormatSymbols;
    ...
    .line 37
    invoke-static {p0}, Landroidx/core/widget/r$c;->b(Landroid/icu/text/DecimalFormatSymbols;)[Ljava/lang/String;
...
.method public static o(Landroid/widget/TextView;)Landroidx/core/text/i$b;
    .locals 3
    ...
    .line 6
    .line 7
    new-instance v0, Landroidx/core/text/i$b;

    .line 8
    .line 9
    invoke-static {p0}, Landroidx/core/widget/r$c;->c(Landroid/widget/TextView;)Landroid/text/PrecomputedText$Params;
    ...
    .line 13
    invoke-direct {v0, p0}, Landroidx/core/text/i$b;-><init>(Landroid/text/PrecomputedText$Params;)V
    ...
    .line 17
    :cond_0
    new-instance v0, Landroidx/core/text/i$b$a;
    ...
    .line 27
    .line 28
    invoke-direct {v0, v1}, Landroidx/core/text/i$b$a;-><init>(Landroid/text/TextPaint;)V
    ...
    .line 35
    invoke-virtual {v0, v1}, Landroidx/core/text/i$b$a;->b(I)Landroidx/core/text/i$b$a;
    ...
    .line 42
    invoke-virtual {v0, v1}, Landroidx/core/text/i$b$a;->c(I)Landroidx/core/text/i$b$a;
    ...
    .line 49
    invoke-virtual {v0, p0}, Landroidx/core/text/i$b$a;->d(Landroid/text/TextDirectionHeuristic;)Landroidx/core/text/i$b$a;

    .line 50
    .line 51
    .line 52
    invoke-virtual {v0}, Landroidx/core/text/i$b$a;->a()Landroidx/core/text/i$b;
...
.method public static q(Landroid/widget/TextView;[II)V
    ...
    .line 6
    .line 7
    invoke-static {p0, p1, p2}, Landroidx/core/widget/r$b;->g(Landroid/widget/TextView;[II)V
...
.method public static r(Landroid/widget/TextView;I)V
    ...
    .line 6
    .line 7
    invoke-static {p0, p1}, Landroidx/core/widget/r$b;->h(Landroid/widget/TextView;I)V
...
.method public static y(Landroid/widget/TextView;I)V
    ...
    .line 9
    .line 10
    invoke-static {p0, p1}, Landroidx/core/widget/r$c;->d(Landroid/widget/TextView;I)V
