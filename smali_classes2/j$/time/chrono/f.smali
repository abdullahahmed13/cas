...
.method public static o(Lj$/time/chrono/Chronology;Lj$/time/temporal/l;)Lj$/time/chrono/f;
    .locals 3
...
# virtual methods
.method public final A(Lj$/time/ZoneId;)Lj$/time/chrono/ChronoZonedDateTime;
    .locals 1

    const/4 v0, 0x0

    .line 366
    invoke-static {p1, v0, p0}, Lj$/time/chrono/j;->v(Lj$/time/ZoneId;Lj$/time/ZoneOffset;Lj$/time/chrono/f;)Lj$/time/chrono/j;
...
.method public final B(Lj$/time/chrono/b;JJJJ)Lj$/time/chrono/f;
    .locals 16
    ...
    invoke-virtual {v0, v1, v2}, Lj$/time/chrono/f;->Q(Lj$/time/temporal/l;Lj$/time/LocalTime;)Lj$/time/chrono/f;
    ...
    invoke-interface {v1, v8, v9, v3}, Lj$/time/chrono/b;->b(JLj$/time/temporal/r;)Lj$/time/chrono/b;
...
.method public final J(JLj$/time/temporal/p;)Lj$/time/chrono/f;
    .locals 2
    ...
    invoke-virtual {p0, v0, p1}, Lj$/time/chrono/f;->Q(Lj$/time/temporal/l;Lj$/time/LocalTime;)Lj$/time/chrono/f;
    ...
    invoke-interface {v0, p1, p2, p3}, Lj$/time/chrono/b;->a(JLj$/time/temporal/p;)Lj$/time/chrono/b;

    move-result-object p1

    iget-object p2, p0, Lj$/time/chrono/f;->b:Lj$/time/LocalTime;

    invoke-virtual {p0, p1, p2}, Lj$/time/chrono/f;->Q(Lj$/time/temporal/l;Lj$/time/LocalTime;)Lj$/time/chrono/f;
...
.method public final Q(Lj$/time/temporal/l;Lj$/time/LocalTime;)Lj$/time/chrono/f;
    .locals 2
...
.method public final bridge synthetic a(JLj$/time/temporal/p;)Lj$/time/chrono/ChronoLocalDateTime;
    ...
    .line 100
    invoke-virtual {p0, p1, p2, p3}, Lj$/time/chrono/f;->J(JLj$/time/temporal/p;)Lj$/time/chrono/f;
...
.method public final e(Lj$/time/LocalDate;)Lj$/time/chrono/ChronoLocalDateTime;
    ...
    invoke-virtual {p0, p1, v0}, Lj$/time/chrono/f;->Q(Lj$/time/temporal/l;Lj$/time/LocalTime;)Lj$/time/chrono/f;
...
.method public final g(Lj$/time/temporal/p;)I
    ...
    .line 262
    :cond_1
    invoke-virtual {p0, p1}, Lj$/time/chrono/f;->j(Lj$/time/temporal/p;)Lj$/time/temporal/t;

    move-result-object v0

    invoke-virtual {p0, p1}, Lj$/time/chrono/f;->i(Lj$/time/temporal/p;)J
...
.method public final v(JLj$/time/temporal/r;)Lj$/time/chrono/f;
    ...
    invoke-virtual {v0, v1, v6}, Lj$/time/chrono/f;->Q(Lj$/time/temporal/l;Lj$/time/LocalTime;)Lj$/time/chrono/f;
    ...
    invoke-virtual/range {v7 .. v16}, Lj$/time/chrono/f;->B(Lj$/time/chrono/b;JJJJ)Lj$/time/chrono/f;
    ...
    invoke-virtual/range {v0 .. v9}, Lj$/time/chrono/f;->B(Lj$/time/chrono/b;JJJJ)Lj$/time/chrono/f;
    ...
    invoke-virtual {v0, v3, v4}, Lj$/time/chrono/f;->Q(Lj$/time/temporal/l;Lj$/time/LocalTime;)Lj$/time/chrono/f;
    ...
    invoke-virtual/range {v5 .. v14}, Lj$/time/chrono/f;->B(Lj$/time/chrono/b;JJJJ)Lj$/time/chrono/f;
    ...
    invoke-interface {v4}, Lj$/time/chrono/b;->getChronology()Lj$/time/chrono/Chronology;
    ...
    invoke-static {v4, v1}, Lj$/time/chrono/f;->o(Lj$/time/chrono/Chronology;Lj$/time/temporal/l;)Lj$/time/chrono/f;
