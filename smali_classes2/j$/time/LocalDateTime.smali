...
.method static constructor <clinit>()V
    ...
    invoke-static {v0, v1}, Lj$/time/LocalDateTime;->J(Lj$/time/LocalDate;Lj$/time/LocalTime;)Lj$/time/LocalDateTime;
...
.method public static J(Lj$/time/LocalDate;Lj$/time/LocalTime;)Lj$/time/LocalDateTime;
    .locals 1
...
.method public static Q(JILj$/time/ZoneOffset;)Lj$/time/LocalDateTime;
    .locals 5
...
.method public static v(Lj$/time/temporal/m;)Lj$/time/LocalDateTime;
    .locals 5
    ...
    :cond_2
    :try_start_0
    invoke-static {p0}, Lj$/time/LocalDate;->B(Lj$/time/temporal/m;)Lj$/time/LocalDate;

    move-result-object v0

    .line 457
    invoke-static {p0}, Lj$/time/LocalTime;->B(Lj$/time/temporal/m;)Lj$/time/LocalTime;
...
.method public final B(Lj$/time/chrono/ChronoLocalDateTime;)Z
    ...
    invoke-virtual {p0, p1}, Lj$/time/LocalDateTime;->o(Lj$/time/LocalDateTime;)I
    ...
    invoke-interface {v2}, Lj$/time/chrono/b;->E()J
...
.method public final I(Lj$/time/chrono/ChronoLocalDateTime;)I
    .locals 1
    ...
    .line 1823
    :cond_0
    invoke-super {p0, p1}, Lj$/time/chrono/ChronoLocalDateTime;->I(Lj$/time/chrono/ChronoLocalDateTime;)I
...
.method public final S(JLj$/time/temporal/r;)Lj$/time/LocalDateTime;
    ...
    invoke-virtual {v4, v2, v3, v1}, Lj$/time/LocalDate;->X(JLj$/time/temporal/r;)Lj$/time/LocalDate;

    move-result-object v1

    iget-object v2, v0, Lj$/time/LocalDateTime;->b:Lj$/time/LocalTime;

    invoke-virtual {v0, v1, v2}, Lj$/time/LocalDateTime;->W(Lj$/time/LocalDate;Lj$/time/LocalTime;)Lj$/time/LocalDateTime;
    ...
    invoke-virtual {v0, v1, v6}, Lj$/time/LocalDateTime;->W(Lj$/time/LocalDate;Lj$/time/LocalTime;)Lj$/time/LocalDateTime;
    ...
    invoke-virtual/range {v7 .. v16}, Lj$/time/LocalDateTime;->U(Lj$/time/LocalDate;JJJJ)Lj$/time/LocalDateTime;
    ...
    invoke-virtual/range {v0 .. v9}, Lj$/time/LocalDateTime;->U(Lj$/time/LocalDate;JJJJ)Lj$/time/LocalDateTime;
    ...
    invoke-virtual {v0, v3, v4}, Lj$/time/LocalDateTime;->W(Lj$/time/LocalDate;Lj$/time/LocalTime;)Lj$/time/LocalDateTime;
    ...
    invoke-virtual/range {v5 .. v14}, Lj$/time/LocalDateTime;->U(Lj$/time/LocalDate;JJJJ)Lj$/time/LocalDateTime;
    ...
    .line 1196
    :cond_0
    invoke-interface {v1, v0, v2, v3}, Lj$/time/temporal/r;->o(Lj$/time/temporal/l;J)Lj$/time/temporal/l;
...
.method public final U(Lj$/time/LocalDate;JJJJ)Lj$/time/LocalDateTime;
    .locals 18
    ...
    :cond_1
    invoke-static {v2, v3}, Lj$/time/LocalTime;->S(J)Lj$/time/LocalTime;

    move-result-object v2

    .line 1571
    :goto_0
    invoke-virtual {v1, v8, v9}, Lj$/time/LocalDate;->Y(J)Lj$/time/LocalDate;
...
.method public final V(JLj$/time/temporal/p;)Lj$/time/LocalDateTime;
    .locals 2
    ...
    invoke-virtual {v1, p1, p2, p3}, Lj$/time/LocalTime;->b0(JLj$/time/temporal/p;)Lj$/time/LocalTime;

    move-result-object p1

    invoke-virtual {p0, v0, p1}, Lj$/time/LocalDateTime;->W(Lj$/time/LocalDate;Lj$/time/LocalTime;)Lj$/time/LocalDateTime;
    ...
    invoke-virtual {p0, p1, p2}, Lj$/time/LocalDateTime;->W(Lj$/time/LocalDate;Lj$/time/LocalTime;)Lj$/time/LocalDateTime;
...
.method public final W(Lj$/time/LocalDate;Lj$/time/LocalTime;)Lj$/time/LocalDateTime;
    .locals 1
...
.method public final bridge synthetic a(JLj$/time/temporal/p;)Lj$/time/chrono/ChronoLocalDateTime;
    ...
    .line 135
    invoke-virtual {p0, p1, p2, p3}, Lj$/time/LocalDateTime;->V(JLj$/time/temporal/p;)Lj$/time/LocalDateTime;
...
.method public final c(JLj$/time/temporal/r;)Lj$/time/chrono/ChronoLocalDateTime;
    ...
    invoke-virtual {p1, v0, v1, p3}, Lj$/time/LocalDateTime;->S(JLj$/time/temporal/r;)Lj$/time/LocalDateTime;
...
.method public final bridge synthetic compareTo(Ljava/lang/Object;)I
    ...
    invoke-virtual {p0, p1}, Lj$/time/LocalDateTime;->I(Lj$/time/chrono/ChronoLocalDateTime;)I
...
.method public final d(Lj$/time/f;)Ljava/lang/Object;
    ...
    .line 1599
    :cond_0
    invoke-super {p0, p1}, Lj$/time/chrono/ChronoLocalDateTime;->d(Lj$/time/f;)Ljava/lang/Object;
...
.method public final e(Lj$/time/LocalDate;)Lj$/time/chrono/ChronoLocalDateTime;
    .locals 1

    .line 920
    iget-object v0, p0, Lj$/time/LocalDateTime;->b:Lj$/time/LocalTime;

    invoke-virtual {p0, p1, v0}, Lj$/time/LocalDateTime;->W(Lj$/time/LocalDate;Lj$/time/LocalTime;)Lj$/time/LocalDateTime;
...
.method public final g(Lj$/time/temporal/p;)I
    ...
    invoke-virtual {v0, p1}, Lj$/time/LocalTime;->g(Lj$/time/temporal/p;)I
    ...
    invoke-virtual {v0, p1}, Lj$/time/LocalDate;->g(Lj$/time/temporal/p;)I
...
.method public final o(Lj$/time/LocalDateTime;)I
    .locals 2
    ...
    .line 1827
    invoke-virtual {v0, v1}, Lj$/time/LocalDate;->o(Lj$/time/LocalDate;)I
