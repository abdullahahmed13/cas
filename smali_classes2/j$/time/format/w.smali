...
.method public constructor <init>(Lj$/time/temporal/m;Lj$/time/format/DateTimeFormatter;)V
    ...
    .line 132
    :cond_0
    sget-object v1, Lj$/time/temporal/q;->b:Lj$/time/f;
    ...
    .line 133
    sget-object v2, Lj$/time/temporal/q;->a:Lj$/time/f;

    invoke-interface {p1, v2}, Lj$/time/temporal/m;->d(Lj$/time/f;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v5}, Lj$/time/temporal/m;->h(Lj$/time/temporal/p;)Z
    ...
    .line 164
    invoke-interface {v3, p1}, Lj$/time/chrono/Chronology;->C(Lj$/time/temporal/m;)Lj$/time/chrono/b;
    ...
    invoke-interface {p1, v7}, Lj$/time/temporal/m;->h(Lj$/time/temporal/p;)Z
    ...
    invoke-direct {v0, v4, p1, v3, v2}, Lj$/time/format/v;-><init>(Lj$/time/chrono/b;Lj$/time/temporal/m;Lj$/time/chrono/Chronology;Lj$/time/ZoneId;)V

    move-object p1, v0

    .line 119
    :goto_4
    iput-object p1, p0, Lj$/time/format/w;->a:Lj$/time/temporal/m;
...
.method public final a(Lj$/time/temporal/p;)Ljava/lang/Long;
    ...
    iget-object v1, p0, Lj$/time/format/w;->a:Lj$/time/temporal/m;

    if-lez v0, :cond_0

    invoke-interface {v1, p1}, Lj$/time/temporal/m;->h(Lj$/time/temporal/p;)Z
    ...
    .line 308
    :cond_0
    invoke-interface {v1, p1}, Lj$/time/temporal/m;->i(Lj$/time/temporal/p;)J
...
.method public final b(Lj$/time/f;)Ljava/lang/Object;
    ...
    .line 287
    iget-object v0, p0, Lj$/time/format/w;->a:Lj$/time/temporal/m;

    invoke-interface {v0, p1}, Lj$/time/temporal/m;->d(Lj$/time/f;)Ljava/lang/Object;
