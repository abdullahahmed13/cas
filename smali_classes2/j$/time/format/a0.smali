...
.field public e:Lj$/time/format/b0;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lj$/time/format/a0;->a:Ljava/util/Map;

    .line 157
    sget-object v0, Lj$/time/o;->d:Lj$/time/o;

    iput-object v0, p0, Lj$/time/format/a0;->h:Lj$/time/o;
...
.method public final d(Lj$/time/f;)Ljava/lang/Object;
    ...
    .line 212
    iget-object p1, p0, Lj$/time/format/a0;->b:Lj$/time/ZoneId;
    ...
    .line 214
    iget-object p1, p0, Lj$/time/format/a0;->c:Lj$/time/chrono/Chronology;
    ...
    .line 216
    iget-object p1, p0, Lj$/time/format/a0;->f:Lj$/time/chrono/b;
    ...
    .line 218
    iget-object p1, p0, Lj$/time/format/a0;->g:Lj$/time/LocalTime;
    ...
    .line 224
    :cond_4
    iget-object v0, p0, Lj$/time/format/a0;->b:Lj$/time/ZoneId;
...
.method public final h(Lj$/time/temporal/p;)Z
    ...
    iget-object v0, p0, Lj$/time/format/a0;->f:Lj$/time/chrono/b;
    ...
    :cond_0
    iget-object v0, p0, Lj$/time/format/a0;->g:Lj$/time/LocalTime;

    if-eqz v0, :cond_1

    .line 183
    invoke-virtual {v0, p1}, Lj$/time/LocalTime;->h(Lj$/time/temporal/p;)Z
...
.method public final i(Lj$/time/temporal/p;)J
    ...
    invoke-virtual {v0, p1}, Lj$/time/LocalTime;->i(Lj$/time/temporal/p;)J
...
.method public final l(Lj$/time/temporal/m;)V
    .locals 8
    ...
    .line 648
    invoke-interface {p1, v2}, Lj$/time/temporal/m;->h(Lj$/time/temporal/p;)Z
    ...
    .line 651
    :try_start_0
    invoke-interface {p1, v2}, Lj$/time/temporal/m;->i(Lj$/time/temporal/p;)J
...
.method public final m()V
    ...
    .line 340
    invoke-virtual {p0, v0}, Lj$/time/format/a0;->n(Lj$/time/ZoneId;)V
...
.method public final n(Lj$/time/ZoneId;)V
    ...
    .line 304
    invoke-static {v2, v3, v0}, Lj$/time/Instant;->o(JI)Lj$/time/Instant;

    move-result-object v0

    .line 353
    iget-object v2, p0, Lj$/time/format/a0;->c:Lj$/time/chrono/Chronology;

    invoke-interface {v2, v0, p1}, Lj$/time/chrono/Chronology;->N(Lj$/time/Instant;Lj$/time/ZoneId;)Lj$/time/chrono/ChronoZonedDateTime;

    move-result-object p1

    .line 354
    invoke-interface {p1}, Lj$/time/chrono/ChronoZonedDateTime;->toLocalDate()Lj$/time/chrono/b;

    move-result-object v0

    invoke-virtual {p0, v0}, Lj$/time/format/a0;->t(Lj$/time/chrono/b;)V
    ...
    invoke-virtual {p1}, Lj$/time/LocalTime;->a0()I
    ...
    invoke-virtual {p0, v1, v0, p1}, Lj$/time/format/a0;->u(Lj$/time/temporal/p;Lj$/time/temporal/a;Ljava/lang/Long;)V
...
.method public final o(JJJJ)V
    ...
    .line 546
    iget-object v0, p0, Lj$/time/format/a0;->e:Lj$/time/format/b0;
    ...
    .line 553
    invoke-static {p1, p2}, Lj$/time/LocalTime;->S(J)Lj$/time/LocalTime;
    ...
    .line 553
    invoke-virtual {p0, p1, p2}, Lj$/time/format/a0;->r(Lj$/time/LocalTime;Lj$/time/o;)V
    ...
    .line 558
    iget-object p7, p0, Lj$/time/format/a0;->e:Lj$/time/format/b0;

    sget-object p8, Lj$/time/format/b0;->SMART:Lj$/time/format/b0;
...
.method public final q()V
    ...
    sget-object v6, Lj$/time/format/b0;->SMART:Lj$/time/format/b0;
    ...
    invoke-virtual {p0, v1, v0, v4}, Lj$/time/format/a0;->u(Lj$/time/temporal/p;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    sget-object v8, Lj$/time/format/b0;->SMART:Lj$/time/format/b0;
    ...
    .line 391
    :cond_4
    invoke-virtual {v1, v6, v7}, Lj$/time/temporal/a;->S(J)V
    ...
    invoke-virtual {p0, v1, v0, v2}, Lj$/time/format/a0;->u(Lj$/time/temporal/p;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    sget-object v3, Lj$/time/format/b0;->LENIENT:Lj$/time/format/b0;
    ...
    .line 402
    invoke-virtual {v2, v6, v7}, Lj$/time/temporal/a;->S(J)V
    ...
    sget-object v6, Lj$/time/format/b0;->LENIENT:Lj$/time/format/b0;
    ...
    invoke-virtual {p0, v1, v0, v6}, Lj$/time/format/a0;->u(Lj$/time/temporal/p;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    invoke-virtual {p0, v1, v0, v8}, Lj$/time/format/a0;->u(Lj$/time/temporal/p;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    sget-object v8, Lj$/time/format/b0;->LENIENT:Lj$/time/format/b0;
    ...
    .line 427
    invoke-virtual {v1, v8, v9}, Lj$/time/temporal/a;->S(J)V
    ...
    invoke-virtual {p0, v1, v0, v10}, Lj$/time/format/a0;->u(Lj$/time/temporal/p;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    .line 459
    invoke-virtual {v9, v10, v11}, Lj$/time/temporal/a;->S(J)V
    ...
    invoke-virtual {p0, v9, v1, v0}, Lj$/time/format/a0;->u(Lj$/time/temporal/p;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    .line 467
    invoke-virtual {v6, v9, v10}, Lj$/time/temporal/a;->S(J)V
    ...
    invoke-virtual {p0, v6, v1, v0}, Lj$/time/format/a0;->u(Lj$/time/temporal/p;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    .line 480
    invoke-virtual/range {v5 .. v13}, Lj$/time/format/a0;->o(JJJJ)V

    :cond_19
    return-void
.end method

.method public final r(Lj$/time/LocalTime;Lj$/time/o;)V
    .locals 4
    ...
    .line 618
    iget-object p1, p0, Lj$/time/format/a0;->h:Lj$/time/o;
    ...
    .line 621
    :goto_0
    iput-object p2, p0, Lj$/time/format/a0;->h:Lj$/time/o;
    ...
    iget-object v0, p0, Lj$/time/format/a0;->h:Lj$/time/o;
    ...
    .line 624
    :cond_4
    iput-object p1, p0, Lj$/time/format/a0;->g:Lj$/time/LocalTime;
...
.method public final t(Lj$/time/chrono/b;)V
    .locals 4
    ...
    iget-object v1, p0, Lj$/time/format/a0;->f:Lj$/time/chrono/b;
    ...
    .line 369
    iget-object v0, p0, Lj$/time/format/a0;->c:Lj$/time/chrono/Chronology;
    ...
    .line 372
    iput-object p1, p0, Lj$/time/format/a0;->f:Lj$/time/chrono/b;
...
.method public final toString()Ljava/lang/String;
    ...
    .line 669
    iget-object v1, p0, Lj$/time/format/a0;->a:Ljava/util/Map;
    ...
    .line 670
    iget-object v2, p0, Lj$/time/format/a0;->b:Lj$/time/ZoneId;
    ...
    iget-object v1, p0, Lj$/time/format/a0;->b:Lj$/time/ZoneId;
    ...
    iget-object v1, p0, Lj$/time/format/a0;->g:Lj$/time/LocalTime;
...
.method public final u(Lj$/time/temporal/p;Lj$/time/temporal/a;Ljava/lang/Long;)V
    .locals 5
