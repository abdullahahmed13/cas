...
.method static constructor <clinit>()V
    ...
    .line 741
    invoke-virtual {v0, v1, v3, v4, v2}, Lj$/time/format/DateTimeFormatterBuilder;->n(Lj$/time/temporal/p;IILj$/time/format/c0;)V
    ...
    .line 746
    invoke-virtual {v0, v9, v10}, Lj$/time/format/DateTimeFormatterBuilder;->q(Lj$/time/format/b0;Lj$/time/chrono/Chronology;)Lj$/time/format/DateTimeFormatter;
    ...
    .line 774
    invoke-virtual {v11, v9, v10}, Lj$/time/format/DateTimeFormatterBuilder;->q(Lj$/time/format/b0;Lj$/time/chrono/Chronology;)Lj$/time/format/DateTimeFormatter;
    ...
    .line 848
    invoke-virtual {v11, v9, v3}, Lj$/time/format/DateTimeFormatterBuilder;->q(Lj$/time/format/b0;Lj$/time/chrono/Chronology;)Lj$/time/format/DateTimeFormatter;
    ...
    .line 875
    invoke-virtual {v7, v9, v3}, Lj$/time/format/DateTimeFormatterBuilder;->q(Lj$/time/format/b0;Lj$/time/chrono/Chronology;)Lj$/time/format/DateTimeFormatter;
    ...
    .line 935
    invoke-virtual {v7, v9, v10}, Lj$/time/format/DateTimeFormatterBuilder;->q(Lj$/time/format/b0;Lj$/time/chrono/Chronology;)Lj$/time/format/DateTimeFormatter;
    ...
    .line 966
    invoke-virtual {v4, v9, v10}, Lj$/time/format/DateTimeFormatterBuilder;->q(Lj$/time/format/b0;Lj$/time/chrono/Chronology;)Lj$/time/format/DateTimeFormatter;
    ...
    sget-object v5, Lj$/time/format/DateTimeFormatterBuilder;->h:Lj$/time/f;
    ...
    .line 1001
    invoke-virtual {v3, v9, v10}, Lj$/time/format/DateTimeFormatterBuilder;->q(Lj$/time/format/b0;Lj$/time/chrono/Chronology;)Lj$/time/format/DateTimeFormatter;

    move-result-object v3

    sput-object v3, Lj$/time/format/DateTimeFormatter;->f:Lj$/time/format/DateTimeFormatter;
    ...
    .line 1123
    invoke-virtual {v0, v3, v4, v5, v2}, Lj$/time/format/DateTimeFormatterBuilder;->n(Lj$/time/temporal/p;IILj$/time/format/c0;)V
    ...
    .line 1169
    invoke-virtual {v0, v9, v3}, Lj$/time/format/DateTimeFormatterBuilder;->q(Lj$/time/format/b0;Lj$/time/chrono/Chronology;)Lj$/time/format/DateTimeFormatter;
    ...
    .line 1291
    invoke-virtual {v3, v8, v4, v2, v0}, Lj$/time/format/DateTimeFormatterBuilder;->n(Lj$/time/temporal/p;IILj$/time/format/c0;)V
    ...
    .line 1306
    invoke-virtual {v3, v0, v1}, Lj$/time/format/DateTimeFormatterBuilder;->q(Lj$/time/format/b0;Lj$/time/chrono/Chronology;)Lj$/time/format/DateTimeFormatter;
...
.method public constructor <init>(Lj$/time/format/d;Ljava/util/Locale;Lj$/time/format/DecimalStyle;Lj$/time/format/b0;Lj$/time/chrono/Chronology;)V
    ...
    iput-object p4, p0, Lj$/time/format/DateTimeFormatter;->d:Lj$/time/format/b0;
...
.method public static ofPattern(Ljava/lang/String;)Lj$/time/format/DateTimeFormatter;
    ...
    .line 2224
    sget-object v1, Lj$/time/format/b0;->SMART:Lj$/time/format/b0;

    const/4 v2, 0x0

    invoke-virtual {v0, p0, v1, v2}, Lj$/time/format/DateTimeFormatterBuilder;->r(Ljava/util/Locale;Lj$/time/format/b0;Lj$/time/chrono/Chronology;)Lj$/time/format/DateTimeFormatter;
...
.method public static ofPattern(Ljava/lang/String;Ljava/util/Locale;)Lj$/time/format/DateTimeFormatter;
    ...
    .line 2224
    sget-object p0, Lj$/time/format/b0;->SMART:Lj$/time/format/b0;

    const/4 v1, 0x0

    invoke-virtual {v0, p1, p0, v1}, Lj$/time/format/DateTimeFormatterBuilder;->r(Ljava/util/Locale;Lj$/time/format/b0;Lj$/time/chrono/Chronology;)Lj$/time/format/DateTimeFormatter;
...
.method public final a(Lj$/time/temporal/m;)Ljava/lang/String;
    ...
    invoke-direct {v2, p1, p0}, Lj$/time/format/w;-><init>(Lj$/time/temporal/m;Lj$/time/format/DateTimeFormatter;)V

    .line 1796
    invoke-virtual {v1, v2, v0}, Lj$/time/format/d;->o(Lj$/time/format/w;Ljava/lang/StringBuilder;)Z
    :try_end_0
...
.method public final b(Ljava/lang/CharSequence;Lj$/time/f;)Ljava/lang/Object;
    .locals 5
    ...
    .line 1901
    :try_start_0
    invoke-virtual {p0, p1}, Lj$/time/format/DateTimeFormatter;->c(Ljava/lang/CharSequence;)Lj$/time/format/a0;

    move-result-object v0

    invoke-virtual {v0, p2}, Lj$/time/format/a0;->d(Lj$/time/f;)Ljava/lang/Object;
...
.method public final c(Ljava/lang/CharSequence;)Lj$/time/format/a0;
    .locals 26
    ...
    invoke-virtual {v6, v4, v1, v5}, Lj$/time/format/d;->v(Lj$/time/format/u;Ljava/lang/CharSequence;I)I
    ...
    .line 265
    invoke-virtual {v9}, Lj$/time/format/a0;->m()V
    ...
    invoke-interface {v1, v2, v4}, Lj$/time/chrono/Chronology;->M(Ljava/util/Map;Lj$/time/format/b0;)Lj$/time/chrono/b;

    move-result-object v1

    invoke-virtual {v9, v1}, Lj$/time/format/a0;->t(Lj$/time/chrono/b;)V

    .line 267
    invoke-virtual {v9}, Lj$/time/format/a0;->q()V
    ...
    invoke-interface {v4, v5, v9, v6}, Lj$/time/temporal/p;->B(Ljava/util/Map;Lj$/time/format/a0;Lj$/time/format/b0;)Lj$/time/temporal/m;
    ...
    invoke-virtual {v9, v1, v2}, Lj$/time/format/a0;->r(Lj$/time/LocalTime;Lj$/time/o;)V
    ...
    invoke-virtual {v9, v5}, Lj$/time/format/a0;->t(Lj$/time/chrono/b;)V
    ...
    invoke-virtual {v9, v5, v1}, Lj$/time/format/a0;->r(Lj$/time/LocalTime;Lj$/time/o;)V
    ...
    invoke-interface {v1, v2, v3}, Lj$/time/chrono/Chronology;->M(Ljava/util/Map;Lj$/time/format/b0;)Lj$/time/chrono/b;
    ...
    invoke-virtual {v9, v8, v12, v1}, Lj$/time/format/a0;->u(Lj$/time/temporal/p;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    invoke-virtual/range {v9 .. v17}, Lj$/time/format/a0;->o(JJJJ)V
    ...
    invoke-virtual {v3, v10, v11}, Lj$/time/temporal/a;->S(J)V
    ...
    .line 634
    invoke-virtual {v9, v1}, Lj$/time/format/a0;->l(Lj$/time/temporal/m;)V
    ...
    invoke-interface {v1, v2}, Lj$/time/chrono/b;->F(Lj$/time/LocalTime;)Lj$/time/chrono/ChronoLocalDateTime;
    ...
    invoke-interface {v1, v3}, Lj$/time/chrono/b;->L(Lj$/time/temporal/TemporalAmount;)Lj$/time/chrono/b;
    ...
    invoke-static {v1}, Lj$/time/ZoneOffset;->V(I)Lj$/time/ZoneOffset;
    ...
    invoke-interface {v2, v3}, Lj$/time/chrono/b;->F(Lj$/time/LocalTime;)Lj$/time/chrono/ChronoLocalDateTime;

    move-result-object v2

    invoke-interface {v2, v1}, Lj$/time/chrono/ChronoLocalDateTime;->A(Lj$/time/ZoneId;)Lj$/time/chrono/ChronoZonedDateTime;
    ...
    invoke-interface {v1, v2}, Lj$/time/chrono/ChronoLocalDateTime;->A(Lj$/time/ZoneId;)Lj$/time/chrono/ChronoZonedDateTime;
