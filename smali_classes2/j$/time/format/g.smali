...
.method public final o(Lj$/time/format/w;Ljava/lang/StringBuilder;)Z
    ...
    invoke-virtual {v0, v2}, Lj$/time/format/w;->a(Lj$/time/temporal/p;)Ljava/lang/Long;

    move-result-object v2

    .line 238
    iget-object v0, v0, Lj$/time/format/w;->a:Lj$/time/temporal/m;

    .line 3416
    sget-object v3, Lj$/time/temporal/a;->NANO_OF_SECOND:Lj$/time/temporal/a;

    invoke-interface {v0, v3}, Lj$/time/temporal/m;->h(Lj$/time/temporal/p;)Z
    ...
    .line 3417
    invoke-interface {v0, v3}, Lj$/time/temporal/m;->i(Lj$/time/temporal/p;)J
    ...
    invoke-static {v5, v6, v4, v2}, Lj$/time/LocalDateTime;->Q(JILj$/time/ZoneOffset;)Lj$/time/LocalDateTime;
    ...
    invoke-static {v12, v13, v4, v2}, Lj$/time/LocalDateTime;->Q(JILj$/time/ZoneOffset;)Lj$/time/LocalDateTime;
...
.method public final v(Lj$/time/format/u;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {v1, v8, v10, v11}, Lj$/time/format/DateTimeFormatterBuilder;->r(Ljava/util/Locale;Lj$/time/format/b0;Lj$/time/chrono/Chronology;)Lj$/time/format/DateTimeFormatter;
    ...
    .line 3490
    invoke-virtual {v1, v8, v10, v4}, Lj$/time/format/d;->v(Lj$/time/format/u;Ljava/lang/CharSequence;I)I
    ...
    .line 362
    invoke-static {v2, v6, v5, v3}, Lj$/time/LocalTime;->Q(IIII)Lj$/time/LocalTime;
    ...
    .line 1286
    invoke-virtual {v12, v5, v6}, Lj$/time/LocalDate;->Y(J)Lj$/time/LocalDate;

    move-result-object v5

    .line 1287
    invoke-virtual {v3, v5, v2}, Lj$/time/LocalDateTime;->W(Lj$/time/LocalDate;Lj$/time/LocalTime;)Lj$/time/LocalDateTime;
