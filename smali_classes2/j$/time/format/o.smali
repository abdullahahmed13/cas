...
.method public final a(Lj$/time/format/w;J)J
    ...
    .line 238
    iget-object p1, p1, Lj$/time/format/w;->a:Lj$/time/temporal/m;
    ...
    .line 2982
    invoke-interface {p1, v2}, Lj$/time/chrono/Chronology;->C(Lj$/time/temporal/m;)Lj$/time/chrono/b;
...
.method public final c(Lj$/time/format/u;JII)I
    ...
    .line 2997
    :cond_0
    invoke-interface {v1, v0}, Lj$/time/chrono/Chronology;->C(Lj$/time/temporal/m;)Lj$/time/chrono/b;

    move-result-object v0

    iget-object v1, p0, Lj$/time/format/i;->a:Lj$/time/temporal/p;

    invoke-interface {v0, v1}, Lj$/time/temporal/m;->g(Lj$/time/temporal/p;)I
    ...
    .line 3024
    :goto_2
    iget-object v4, v2, Lj$/time/format/i;->a:Lj$/time/temporal/p;
    ...
    invoke-virtual/range {v3 .. v8}, Lj$/time/format/u;->f(Lj$/time/temporal/p;JII)I
...
.method public final d()Lj$/time/format/i;
    ...
    invoke-direct/range {v2 .. v7}, Lj$/time/format/o;-><init>(Lj$/time/temporal/p;IILj$/time/chrono/b;I)V
