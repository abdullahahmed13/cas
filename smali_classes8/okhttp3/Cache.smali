...
.method public constructor <init>(Ljava/io/File;J)V
    ...
    invoke-static {v1, p1, v4, v2, v3}, Lokio/w0$a;->g(Lokio/w0$a;Ljava/io/File;ZILjava/lang/Object;)Lokio/w0;

    move-result-object p1

    .line 7
    invoke-direct {p0, v0, p1, p2, p3}, Lokhttp3/Cache;-><init>(Lokio/u;Lokio/w0;J)V

    return-void
.end method

.method public constructor <init>(Lokio/u;Lokio/w0;J)V
    .locals 7
    .param p1    # Lokio/u;
        .annotation build Lqi/l;
        .end annotation
    ...
    .line 4
    invoke-direct/range {v1 .. v6}, Lokhttp3/Cache;-><init>(Lokio/w0;JLokio/u;Lokhttp3/internal/concurrent/TaskRunner;)V

    return-void
.end method

.method public constructor <init>(Lokio/w0;JLokio/u;Lokhttp3/internal/concurrent/TaskRunner;)V
    .locals 9
    .param p1    # Lokio/w0;
        .annotation build Lqi/l;
        .end annotation
    ...
    invoke-direct/range {v1 .. v8}, Lokhttp3/internal/cache/DiskLruCache;-><init>(Lokio/u;Lokio/w0;IIJLokhttp3/internal/concurrent/TaskRunner;)V
...
.method public final -deprecated_directory()Ljava/io/File;
    ...
    .line 2
    .line 3
    invoke-virtual {v0}, Lokhttp3/internal/cache/DiskLruCache;->getDirectory()Lokio/w0;
    ...
    .line 7
    invoke-virtual {v0}, Lokio/w0;->toFile()Ljava/io/File;
...
.method public final directoryPath()Lokio/w0;
    .locals 1
    .annotation build Ldg/j;
        name = "directoryPath"
    .end annotation
...
.method public final get$okhttp(Lokhttp3/Request;)Lokhttp3/Response;
    ...
    .line 29
    invoke-virtual {v0, v3}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;->getSource(I)Lokio/h1;
    ...
    .line 33
    invoke-direct {v2, v3}, Lokhttp3/Cache$Entry;-><init>(Lokio/h1;)V
    :try_end_1
