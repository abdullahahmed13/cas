...
.method static constructor <clinit>()V
    ...
    .line 27
    .line 28
    invoke-static {v0, v1}, Lkotlin/text/y;->x4(Ljava/lang/String;Ljava/lang/CharSequence;)Ljava/lang/String;
...
.method public static final asFactory(Lokhttp3/EventListener;)Lokhttp3/EventListener$Factory;
    ...
    .line 7
    .line 8
    invoke-direct {v0, p0}, Lokhttp3/internal/c;-><init>(Lokhttp3/EventListener;)V
...
.method public static final checkDuration-HG0u8IE(Ljava/lang/String;J)I
    ...
    .line 5
    .line 6
    invoke-static {p1, p2}, Lkotlin/time/h;->V(J)Z
...
.method public static final discard(Lokio/h1;ILjava/util/concurrent/TimeUnit;)Z
    .locals 1
    .param p0    # Lokio/h1;
        .annotation build Lqi/l;
        .end annotation
    ...
    .line 11
    :try_start_0
    invoke-static {p0, p1, p2}, Lokhttp3/internal/_UtilJvmKt;->skipAll(Lokio/h1;ILjava/util/concurrent/TimeUnit;)Z
...
.method public static final isHealthy(Ljava/net/Socket;Lokio/BufferedSource;)Z
    ...
    .line 18
    .line 19
    invoke-interface {p1}, Lokio/BufferedSource;->H5()Z
...
.method public static final readBomAsCharset(Lokio/BufferedSource;Ljava/nio/charset/Charset;)Ljava/nio/charset/Charset;
    ...
    .line 10
    .line 11
    invoke-static {}, Lokhttp3/internal/_UtilCommonKt;->getUNICODE_BOMS()Lokio/u0;
    ...
    .line 35
    .line 36
    sget-object p0, Lkotlin/text/g;->a:Lkotlin/text/g;

    .line 37
    .line 38
    invoke-virtual {p0}, Lkotlin/text/g;->b()Ljava/nio/charset/Charset;
    ...
    .line 49
    :cond_1
    sget-object p0, Lkotlin/text/g;->e:Ljava/nio/charset/Charset;
    ...
    .line 53
    .line 54
    invoke-virtual {p0}, Lkotlin/text/g;->c()Ljava/nio/charset/Charset;
    ...
    .line 59
    :cond_3
    sget-object p0, Lkotlin/text/g;->d:Ljava/nio/charset/Charset;
...
.method public static final skipAll(Lokio/BufferedSource;)V
    ...
    .line 15
    invoke-interface {p0}, Lokio/BufferedSource;->x()Lokio/l;
...
.method public static final skipAll(Lokio/h1;ILjava/util/concurrent/TimeUnit;)Z
    .locals 11
    .param p0    # Lokio/h1;
        .annotation build Lqi/l;
        .end annotation
    ...
    .line 2
    invoke-interface {p0}, Lokio/h1;->timeout()Lokio/k1;

    move-result-object v2

    invoke-virtual {v2}, Lokio/k1;->hasDeadline()Z
    ...
    invoke-virtual {v2}, Lokio/k1;->deadlineNanoTime()J
    ...
    invoke-virtual {v2, p1, p2}, Lokio/k1;->deadlineNanoTime(J)Lokio/k1;
    ...
    .line 6
    invoke-interface {p0, p1, v7, v8}, Lokio/h1;->read(Lokio/l;J)J
...
.method public static final threadName(Ljava/lang/String;Leg/a;)V
    .locals 2
    .param p0    # Ljava/lang/String;
        .annotation build Lqi/l;
        .end annotation
