...
.method private static a(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string v10, "ALTER TABLE analytic_item RENAME TO "
...
.method private static a(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/Context;Lcom/salesforce/marketingcloud/util/Crypto;)V
    ...
    .line 2
    const-string v3, "id,platform,subscriber_key,et_app_id,badge,timezone,dst,tags,attributes,platform_version,push_enabled,location_enabled,hwid,gcm_sender_id,locale"
    ...
    invoke-static {p0, v5}, Lcom/newrelic/agent/android/instrumentation/SQLiteInstrumentation;->execSQL(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V
    ...
    const-string v6, "INSERT INTO registration ("
    ...
    const-string v3, " FROM old_registration"
    ...
    invoke-static {p1, v4}, Lcom/salesforce/marketingcloud/util/c;->a(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 12
    invoke-static {p0, v1, v3, v4, v4}, Lcom/newrelic/agent/android/instrumentation/SQLiteInstrumentation;->update(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-static {v3, p1, v5, v7}, Lcom/salesforce/marketingcloud/g;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-static {v2, p1, v3, v5}, Lcom/salesforce/marketingcloud/g;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
    ...
    invoke-static {p0, p1, v4}, Lcom/newrelic/agent/android/instrumentation/SQLiteInstrumentation;->rawQuery(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    ...
    check-cast v5, Lcom/salesforce/marketingcloud/storage/db/upgrades/d$a;
    ...
    .line 31
    invoke-static {v3}, Lcom/salesforce/marketingcloud/storage/db/upgrades/d;->a(Ljava/util/Collection;)Ljava/lang/String;

    move-result-object v3

    invoke-interface {p2, v3}, Lcom/salesforce/marketingcloud/util/Crypto;->encString(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v1, v2, v3, v4}, Lcom/newrelic/agent/android/instrumentation/SQLiteInstrumentation;->update(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    :try_end_5
    ...
    const-string v4, "Unable to remove duplicate attributes from row"

    filled-new-array {v2}, [Ljava/lang/Object;

    move-result-object v2

    invoke-static {v3, v4, v2}, Lcom/salesforce/marketingcloud/g;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private static b(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string v4, "ALTER TABLE messages RENAME TO "
    ...
    const-string v4, "INSERT INTO messages SELECT id, alert, sound, open_direct, start_date, end_date, message_type, content_type, url, custom, keys, period_show_count, last_shown_date, next_allowed_show, show_count, message_limit, rolling_period, period_type, number_of_periods, messages_per_period, proximity, has_entered, notify_id FROM "
